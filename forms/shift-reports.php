    ...
    <ul class="space-y-3">
      <template x-for="(item, idx) in checklist" :key="idx">
        <li class="flex items-start gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
          <input type="checkbox" class="h-5 w-5 rounded border-gray-300 text-gray-900 focus:ring-0"
  ...
  <section class="bg-white p-6 rounded-xl border" x-data="{v:''}">
    ...
    <fieldset class="space-y-2">
      <label class="flex items-center gap-2">
        <input type="radio" class="h-4 w-4 border-gray-300 text-gray-900 focus:ring-0"
...
function shiftForm() {
  return {
    ...
    eveningChecklist: [
      {label: 'Count register and process final payments', done:false},
      {label: 'Complete deep cleaning of all areas', done:false},
      {label: 'Sanitize all tools and stations', done:false},
      {label: 'Start laundry and towel washing', done:false},
      {label: 'Stock inventory for tomorrow', done:false},
      {label: 'Turn off all equipment and electronics', done:false},
      {label: 'Turn off all lights', done:false},
      {label: 'Lock all doors and windows', done:false},
      {label: 'Set security system', done:false},
      {label: 'Complete cash drop and deposit preparation', done:false},
      {label: 'Leave notes for morning staff', done:false},
      {label: 'Complete final walkthrough checklist', done:false},
    ],
    progress: 0,
    jsonPayload: '',
    init() {
