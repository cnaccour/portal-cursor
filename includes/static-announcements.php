...
function generateEducationScheduleHtml() {
    ...
    <div class="mb-8">
        <div class="text-left">
            <h3 class="text-xl font-bold text-gray-900 mb-6">2025 Training Schedule</h3>
            <p class="text-gray-700 text-sm leading-relaxed">Complete 2025 education schedule with monthly training sessions on social media, styling techniques, product knowledge, and business development.</p>
        </div>
    </div>
