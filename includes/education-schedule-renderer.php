    ...
    <div class="education-schedule-2025">
        ...
        <div class="mb-8 bg-gradient-to-r from-black to-gray-800 text-white p-6 rounded-xl">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button type="button" onclick="event.preventDefault(); event.stopPropagation(); exportAllToCalendar()" 
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg border <?= $isCompleted ? 'border-gray-200 opacity-75' : 'border-gray-300 shadow-sm' ?> overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <?php if ($isUpcoming): ?>
                        <button type="button" onclick="event.preventDefault(); event.stopPropagation(); addToCalendar(<?= htmlspecialchars(json_encode($session), ENT_QUOTES) ?>)" 
