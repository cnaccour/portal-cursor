...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-8">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="relative">
                <svg class="absolute left-3 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="top: 50%; transform: translateY(-50%);">
...
<?php if (empty($articles)): ?>
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
        ...
        <p class="text-gray-600">Knowledge base articles will appear here once they are published.</p>
    </div>
<?php else: ?>
