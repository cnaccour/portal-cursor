                ...
                <div class="bg-white rounded-md border hover:border-gray-300 transition-all duration-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <?php if (empty($announcement['is_static'])): ?>
                            ...
                            <?php else: ?>
                            <button disabled
                                    class="w-full sm:flex-1 inline-flex items-center justify-center px-4 py-2 border border-gray-200 rounded-md text-sm font-medium text-gray-400 bg-gray-50 cursor-not-allowed">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
